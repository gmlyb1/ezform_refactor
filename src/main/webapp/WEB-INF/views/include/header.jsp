...
<c:set var="em_id" value="${sessionScope.em_id}" />
	...
	<aside class="sidebar sidebar-default navs-rounded-all ">
		<div
			...
			<a href="/ezform/main" class="navbar-brand"> <!--Logo start--> 
			...
			<div class="collapse navbar-collapse" id="sidebar">
				...
				<ul class="navbar-nav iq-main-menu">
					...
					<c:if test="${em_id == 9999 }">
						<li class="nav-item">
							<a class="nav-link" aria-current="page" href="/ezform/ez_manage/home"> 
								<i class="icon">
								...
								<span class="item-name">관리자 페이지</span>
							</a>
						</li>					
					</c:if>
