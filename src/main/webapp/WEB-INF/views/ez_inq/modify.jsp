	...
	<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#modify").click(function(){			
				...
				fr.attr("action","/ezform/ez_inq/modify");
	                        ...
	                        <tr>
	                           <th>
	                              ...
	                              <div class="mb-3">
	                                ...
	                                <input class="form-control form-control-sm" type="text" name="inq_title" placeholder="제목" value="${vo.inq_title}">
								  </div>	
	                              <div class="mb-3">
	                                 <label class="form-label">첨부파일</label>
	                                 <input class="form-control form-control-sm" type="file" accept="image/*" id="inq_file" name="uploadFile" >
	                              </div>
	                              <div class="mb-3">
	                                 <label class="form-label">내용</label>
	                                 <textarea class="form-control" rows="10" style="resize: none; background-color:white;" name="inq_content">${vo.inq_content }</textarea>
	                              </div>
	                              <hr>
	                              <div class="mb-3" style="text-align:right;">
									<button type="submit" class="btn btn-primary btn-sm" id="modify">수정</button>
									<input type="button" class="btn btn-primary btn-sm" value="취소" onclick="location.href='./read?inq_no=${vo.inq_no}';">
	                           	  </div>
	                           	</form>	  
                           </th>
                        </tr>   
