...
<script type="text/javascript">
	...
	function reg_chk() {
		if (document.regFr.inq_title.value == "") {
			alert("제목을 입력하세요");
			return false;
		}
		if (document.regFr.inq_content.value == "") {
			alert("내용을 입력하세요");
			return false;
		}
		 ...
		 if (document.regFr.uploadFile.value != "") {
			...
			var fileSize = $("#inq_file")[0].files[0].size;
	                        ...
	                        <tr>
	                           <th>
	                              <div class="mb-3">
									...
									<input class="form-control form-control-sm" id="inq_title" name="inq_title" >
	                              </div>
	                              <div class="mb-3">
	                                 <label class="form-label">첨부파일</label>
	                                 <input type="file" class="form-control form-control-sm" id="inq_file" name="uploadFile">
	                              </div>
	                              <div class="mb-3">
	                                 <label class="form-label">내용</label>
	                                 <textarea class="form-control" rows="10" id="myEditor" name="inq_content" style="resize: none;"></textarea>
	                              </div>
	                           </th>
	                        </tr>   
	                        <tr>
