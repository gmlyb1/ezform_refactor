...
<script src="${pageContext.request.contextPath }/resources/js/ezform_js/material_event.js"></script>
               	  ...
               	  <form role="form"  action="" method="post" enctype="multipart/form-data">
	                  <table id="basic-table" class="table table-striped mb-0" role="grid">
	                     ...
	                     <tbody>
	                        <tr>
	                           <th>
	                        	  <input type="hidden" name="ma_seq" value="${mVO.ma_seq }"/>
	                              <div class="mb-3">
	                                <label class="form-label">제목</label>
									<p class="h6">${mVO.ma_title }</p>
								  </div>	
	                              <div class="mb-3">
	                                 <label class="form-label">첨부파일</label>
	                                 <c:choose>
				                   		<c:when test="${mVO.ma_file != null }">
				                   			<a href="filedown?fileName=${mVO.ma_file }"><p>${mVO.ma_file }</p></a>
				                   		</c:when>
				                   		<c:otherwise>
	                              ...
	                              <div class="mb-3">
	                                 ...
	                                 <textarea class="form-control" rows="10" style="resize: none; background-color:white;" readonly>${mVO.ma_content }</textarea>
	                              </div>
	                           </th>
	                        </tr>   
	                        <tr>
	                           <td style="text-align:right;">
	                              <div class="mb-3">
									<input type="submit" class="btn btn-primary btn-sm"  id="material_modify" value="수정하기"/>
									<input type="submit" class="btn btn-primary btn-sm"  id="material_remove" value="삭제하기"/>		 	
								 	<input type="button" class="btn btn-primary btn-sm"  id="material_list" value="목록으로"/>
	                              </div>
	                           </td>  
	                        </tr>
	                     </tbody>
