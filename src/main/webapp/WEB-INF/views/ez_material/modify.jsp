	                        ...
	                        <tr>
	                           <th>
	                              <div class="mb-3">
									...
									<input class="form-control form-control-sm" id="ma_title" name="ma_title" value="${mVO.ma_title }">
								  </div>	
	                              <div class="mb-3">
	                                 <label class="form-label">첨부파일</label>
	                                 <input type="file" class="form-control form-control-sm" id="ma_file" name="uploadFile">
	                              </div>
	                              <div class="mb-3">
	                                 <label class="form-label">내용</label>
	                                 <textarea class="form-control" rows="10" id="ma_content" name="ma_content" style="resize: none;">${mVO.ma_content }</textarea>
	                              </div>
	                        ...
	                        <tr>
	                           <td style="text-align:right;">
	                              <div class="mb-3">
									...
									<input type="button" class="btn btn-primary btn-sm" id="not_remove" value="취소" onclick="location.href='read?ma_seq=${mVO.ma_seq}';"/>		 
	                              </div>
	                           </td>  
	                        </tr>
	                     </tbody>
